"use client";
// import { Button, Separator, Slider } from "@nextui-org/react";
          ...
          <Card
            ...
            <div className=" hidden  flex-col w-full items-center justify-center border-t-2 border-t-[#4E23CB] sm:flex">
              ...
              <CSSTransition in={animate} timeout={300}>
                {(state: string) => (
                  <div
                    className={cn(`box h-1/2 bg-red-400 flex flex-col items-center justify-center gap-8  absolute w-full bottom-0 bg-white shadow-lg rounded transition-transform duration-300 ${
                      state === "entering"
                        ? "opacity-0 "
                        : state === "entered"
                  ...
                  >
                    ...
                    <PropertyModal propertyId={details.id} shareAmount={propertySliderValue[0]} amount={Number(propertyValuation)} />
                  </div>
                )}
              </CSSTransition>
            </div>
                  ...
                  <LazyLoad className={"w-full"}>
                    <div className="flex w-full flex-col gap-6">
                      ...
                      <div className=" flex w-full items-center justify-between text-[#8459FF]">
                        <div className="">1 share</div>
                        <div className="flex items-center justify-between">
                          ₦{Number(details?.costs?.total_costs_per_share)}
                        </div>
                      </div>
            ...
            <div
              ...
              {details?.costs?.docs && details?.costs?.docs.map(({ docs }, i) => {
                return (
                  ...
                  >
                    <div className="flex gap-2">
                      <Image className="h-8 w-auto" src={DocumentText} alt={""} />
                      <Link href={`${docs}`}> Get Your Documents</Link>
                    </div>
                    <Image className="h-8 w-auto" src={DocumentDownload} alt={""} />
                  </div>
                );
              })}
            </div>
